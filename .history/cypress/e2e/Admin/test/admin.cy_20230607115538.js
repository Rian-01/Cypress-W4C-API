...
describe("Test Case End To End", () => {
  ...
  it("Detail Service", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("detailService")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  //List Service Status Active
  it("List Service Status", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("listServiceStatus")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  it("Detail Service Status", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("detailScheduleV3")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  it("List Vehicle", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("listVehicle")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  it("Detail Vehicle", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("detailVehicle")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  //Find Operator By Type And Role
  it("Find Operator By Type And Role", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("findOperatorTypeAndRole")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  it("List Driver", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("listDriver")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
  ...
  //List Driver Assistant
  it("List Driver Assistant", () => {
    cy.request({
      method: "GET",
      url: `${Cypress.env("baseUrl")}${Cypress.env("listDriverAssistance")}`
    }).then((response) => {
      expect(response.status).to.equal(200);
      cy.log(JSON.stringify(response.body));
    })
...
describe("@Negative Case", () => {
    ...
    it("List  Service Categories", () => {
      cy.request({
          method: "GET",
          url:`${Cypress.env("baseUrl")}/api/v2/service/categories`
      }).then((response) => {
          expect(response.status).to.equal(200);
          expect(response).not.to.be.null
          cy.log(JSON.stringify(response.body));
    ...
    it("Show Detail Service Categories", () => {
      cy.request({
          method: "GET",
          url:`${Cypress.env("baseUrl")}/api/v2/service/categories/0e4`
      }).then((response) => {
          expect(response.status).to.equal(200);
          expect(response).not.to.be.null
          cy.log(JSON.stringify(response.body));
