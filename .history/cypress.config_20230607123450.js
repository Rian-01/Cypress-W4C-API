...
module.exports = defineConfig({
  ...
  env: {
    ...
    dropIndexV2: "/api/v2/drop?start=0&length=10",
    dropIndexV3: "/api/v3/drop?datatable=true&length=10&start=0",
    detailDropV2: "/api/v2/drop/994ec522-b5a6-4ed1-b7df-135acfc1c14d",
